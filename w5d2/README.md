...
- What is data modeling and why we should use it X
- Small example for data modeling X
- Building ERDs X
- Data modeling conventions X
- Data types
...
you've been hacked!!!! OH NOES I'LL GO YANK THE INTERNET CABLE
